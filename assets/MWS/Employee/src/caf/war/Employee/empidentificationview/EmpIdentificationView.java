...
@ManagedBean(name = "EmpIdentificationView")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "EmpIdentificationView", beanType = BeanType.PORTLET)
public class EmpIdentificationView  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {

	private transient caf.war.Employee.Employee employee = null;
	/**
	...
	public caf.war.Employee.Employee getEmployee()  {
		if (employee == null) {
		    employee = (caf.war.Employee.Employee)resolveExpression("#{Employee}");
		}
		return employee;
	}
