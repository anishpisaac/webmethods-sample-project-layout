...
@ManagedBean(name = "EmpIdentificationOverview")
@SessionScoped
@ExpireWithPageFlow
@DTManagedBean(displayName = "EmpIdentificationOverview", beanType = BeanType.PORTLET)
public class EmpIdentificationOverview  extends   com.webmethods.caf.faces.bean.BaseFacesPreferencesBean {
	 ...
	 */
	public EmpIdentificationOverview() {
